...
public interface IMemberDao {
	...
	public static final String FETCH_ADDRESS_BY_ID = "SELECT * FROM address WHERE ADDRESS_ID = :addressId";
	...
	public static final String FETCH_PAYMENT_BY_ID = "SELECT * FROM payment WHERE PAYMENT_ID = :paymentId";
